    ...
    <>
          ...
          <div className="ion-page" id="main-content">
            <ion-header>
              <ion-toolbar color="primary">
                ...
                <ion-title id="header-title">{title}</ion-title>
            ...
            <ion-content fullscreen clsss="main-content">
              <ion-grid>
                <ion-row>
                  <ion-col size-xs="12" size-sm="12" size-md="6">
                    <ion-card class="ion-no-margin ion-no-padding">
                      ...
                      <ion-card-header>
                        ...
                        <ion-card-subtitle>
                          A ship carrying grain leaves Odesa under a deal aimed
                          at easing a global food crisis.
                        </ion-card-subtitle>
                      </ion-card-header>
                      <ion-card-content class="ion-text-justify">
                        ...
                        officials say the ship left the southern port of Odesa
                        early on Monday morning local time.
                      </ion-card-content>
                    </ion-card>
                  </ion-col>
                  <ion-col size-md="3">
                    <ion-card class="ion-no-margin">
                      ...
                      <ion-card-content class="ion-text-justify">
                        ...
                        since March 2020, when they shut in an effort to keep
                        out Covid-19.
                      </ion-card-content>
                    </ion-card>
                  </ion-col>
                  <ion-col size-md="3">
                    <ion-card class="ion-no-margin">
                      ...
                      <ion-card-content class="ion-text-justify">
                        Jacinda Ardern and politicians from across the spectrum
                        have touched down in Samoa, marking the reopening of the
                        Pacific nation.
                      </ion-card-content>
                    </ion-card>
                  </ion-col>
                  ...
                  <ion-col size-xs="12" size-sm="6" size-lg="4" size-xl="3">
                    <ion-item color="light">
                      ...
                      <ion-label color="primary" class="small">
                        1. Mystery as massive sinkhole appears in Chile
                      </ion-label>
                    </ion-item>
                  </ion-col>
                      ...
                      <ion-list>
                        ...
                        <ion-item>
                          <ion-label className="ion-color ion-color-primary">
                            <b>11:14 am</b>
                            <br />I tried the viral Milo and Baileys drink
                          </ion-label>
                          <ion-icon
                        ...
                        <ion-row>
                          <ion-col size-md="6" size-lg="3">
                            <ion-card class="ion-no-margin">
                              ...
                              <ion-card-content class="ion-text-justify">
                                Beaten for first time in eight years, Adam Peaty
                                was "the lowest of the low". His response was
                                remarkable.
                              </ion-card-content>
                            </ion-card>
                          </ion-col>
                          ...
                          <ion-col size-md="6" size-lg="3">
                            <ion-card class="ion-no-margin">
                              ...
                              <ion-card-content class="ion-text-justify">
                                Emma McKeon wins her 19th medal and fifth gold
                                in Birmingham in the mixed 4x100m relay.
                              </ion-card-content>
                            </ion-card>
                          </ion-col>
                          ...
                          <ion-col size-md="6" size-lg="3">
                            <ion-card class="ion-no-margin">
                              ...
                              <ion-card-header>
                                <ion-card-subtitle color="primary">
                                  White Ferns in medal mix at Commonwealth Games
                                </ion-card-subtitle>
                              </ion-card-header>
                              <ion-card-content class="ion-text-justify">
                                Career-best figures from Hayley Jensen in big
                                win over Sri Lanka ensures Kiwis in semifinals.
                              </ion-card-content>
                            </ion-card>
                          </ion-col>
                          ...
                          <ion-col size-md="6" size-lg="3">
                            <ion-card class="ion-no-margin">
                              ...
                              <ion-card-content class="ion-text-justify">
                                No golds for New Zealand on day five as
                                21-year-old pole vaulter Imogen Ayris and the
                                women's bowls four secure bronzes.
                              </ion-card-content>
                            </ion-card>
                          </ion-col>
                        </ion-row>
              ...
              <ion-grid>
                <ion-row>
                  ...
                  <ion-col>
                    <ion-tab-button
                      tab="more"
                      onclick="document.getElementById('icon-menu-button').click()"
                    >
      ...
      <style jsx global>
        {`
          ...
          .main-content{
            backgrond-color:#ffffcc !important;
          }
